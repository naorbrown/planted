...
[Snake Plant](/planted/plants/bedroom/snake-plant/) is the minimalist's first plant. Vertical, geometric, and completely self-sufficient.
...
[Ponytail Palm](/planted/plants/low-maintenance/ponytail-palm/) is the pick when you want something that looks like living sculpture and forgives you for ignoring it.
...
[Fiddle Leaf Fig](/planted/plants/living-room/fiddle-leaf-fig/) is the statement tree. One specimen in the right corner transforms the entire room.
